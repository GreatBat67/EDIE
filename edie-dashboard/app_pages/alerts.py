...
<div class="edie-hero-banner">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div>
            <h2 style="margin: 0; color: #FFFFFF; font-weight: 700;">Alerts & Automated Observability</h2>
            <p style="margin: 4px 0 0 0; color: #94A3B8; font-size: 0.95rem;">Threshold-Based Incident Triggers, ML Anomaly Detection & AI Briefings</p>
        </div>
        <div style="text-align: right; background: rgba(239, 68, 68, 0.15); border: 1px solid #EF4444; padding: 6px 14px; border-radius: 8px;">
            <span style="font-size: 0.8rem; color: #FCA5A5; font-weight: 600;">ACTIVE MONITORS</span>
            <div style="font-size: 1.1rem; font-weight: 700; color: #F8FAFC;">Real-Time Pipeline Watch</div>
        </div>
    </div>
</div>
