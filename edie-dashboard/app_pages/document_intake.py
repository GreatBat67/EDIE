...
<div class="edie-hero-banner">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div>
            <h2 style="margin: 0; color: #FFFFFF; font-weight: 700;">Document Intake & Intelligent OCR</h2>
            <p style="margin: 4px 0 0 0; color: #94A3B8; font-size: 0.95rem;">Snowflake Cortex PARSE_DOCUMENT + Entity Extraction Pipeline</p>
        </div>
        <div style="text-align: right; background: rgba(56, 189, 248, 0.15); border: 1px solid #10B981; padding: 6px 14px; border-radius: 8px;">
            <span style="font-size: 0.8rem; color: #10B981; font-weight: 600;">CORTEX OCR ENGINE</span>
            <div style="font-size: 1.1rem; font-weight: 700; color: #F8FAFC;">Zero-Data Movement</div>
        </div>
    </div>
</div>
